package com.sundol.portfolio.domain

import com.sundol.portfolio.domain.constant.SkillType
import com.sundol.portfolio.domain.entity.*
import com.sundol.portfolio.domain.repository.*
...
class DataInitializer(
    ...
    fun initializeData(){
        ...
        log.info("스프링이 실행되었습니다. 테스트 데이터를 초기화 합니다.")
        ...
        val introductions = mutableListOf<Introduction>(
            Introduction(content = "주도적으로 문제를 찾고, 해결하는 꿀꿀이 입니다.", isActive = true),
        ...
        val links = mutableListOf<Link>(
            Link(name = "Github", content = "https://github.com/sundolNo1", isActive = true),
            Link(name = "Linkedin", content = "https://github.com/sundolNo1",
                isActive = true),
        )
